...
Content.makeFrontInterface(1580, 820);
...
const var VuMeterLeft = createFilmStripVuMeter("VuMeterLeft", 1450, 60, false);
const var VuMeterRight = createFilmStripVuMeter("VuMeterRight", 1410, 60, true);
